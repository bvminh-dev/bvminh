...
function ProjectCard({className, img, fallbackIcon, fallbackIconColors, title, subtitle, text, links, options, tags, onClickCard, id}) {
    ...
    return (
        <Card className={`grid-item ${className}`} onClick={()=>{onClickCard && onClickCard(id)}}>
            <CardBody>
